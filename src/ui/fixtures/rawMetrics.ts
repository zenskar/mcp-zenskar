  ...
  raw_metrics: [
    {
      ...
      api_type: 'PUSH',
      status: 'active',
      description: 'Per-call billing event for /v1/* endpoints',
    ...
    },
    {
      ...
      api_type: 'PUSH',
      status: 'active',
      description: 'GB-hours of object storage',
      created_at: '2024-09-15T08:00:00Z',
    },
    {
      id: 'rm_003',
      ...
      api_type: 'PULL',
      status: 'active',
      description: 'Successful CI pipeline runs per project',
    ...
    },
    {
      ...
      api_type: 'PUSH',
      status: 'archived',
      description: 'Deprecated v1 pageview metric',
