  ...
  aggregates: [
    {
      ...
      status: 'active',
      formula: 'SUM(usage_amount)',
      unit: 'requests',
      last_run_at: '2026-05-07T03:00:00Z',
      created_at: '2024-09-20T08:00:00Z',
    },
    {
      id: 'agg_002',
      name: 'Peak Storage',
      datasource: 'storage_gb',
      status: 'active',
      formula: 'MAX(usage_amount)',
      unit: 'GB',
      last_run_at: '2026-05-07T03:00:00Z',
      created_at: '2024-09-20T08:00:00Z',
    },
    ...
    },
    {
      id: 'agg_004',
      name: 'Webhook Errors',
      datasource: 'webhook_deliveries',
      status: 'active',
      formula: "COUNT_IF(status='failed')",
      unit: 'errors',
      last_run_at: '2026-05-07T03:00:00Z',
    ...
    },
    {
      ...
      datasource: 'legacy_pageviews',
      status: 'paused',
      formula: 'SUM(usage_amount)',
      unit: 'views',
      last_run_at: '2025-08-01T03:00:00Z',
